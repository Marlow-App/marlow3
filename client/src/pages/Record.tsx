            ...
            <div className="flex items-start justify-between gap-4">
              <div className="min-w-0 flex-shrink">
                ...
                <p className="text-[11px] text-muted-foreground/70 mt-0.5 truncate">
                  Sample readings generated by text-to-speech, tones may be slightly off.{" "}
              ...
              <div className="flex gap-1.5 items-center text-[10px] text-muted-foreground whitespace-nowrap shrink-0">
                <span className="font-medium mr-0.5">Tone by Color</span>
